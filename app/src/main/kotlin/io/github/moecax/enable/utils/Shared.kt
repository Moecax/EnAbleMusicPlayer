...
import io.github.moecax.enable.model.Playlist
...
//            }
    ...
    fun serviceRunning(serviceClass: Class<*>, context: Context): Boolean {
        if (serviceClass == io.github.moecax.enable.services.MusicService::class.java) {
            return io.github.moecax.enable.services.MusicService.isServiceRunning
        }
        val manager =
